...
class mash {
 public:
  constexpr auto digest(char_iterator auto mess) const {
    constexpr static_vector k(
    ...
    static_vector res({'j', 'B', 'q', 't', 'C', 'N', 'a', 'V', 'w', 'F', 'S',
                       '6', '0', 'p', '3', 'x', 'K', 'i', 'I', 'H', '8', 'G',
                       'D', '2', 'Y', 'O', 'R', 'W', '9', 'o', '1', 'k', 's',
                       'Z', 'l', 'v', '4', 'P', 'X', '/', 'U', 'M', 'n', 'g',
                       '=', 'N', 'r', 'J', '5', 'b', 'y', 'Q', 'z', 'h', 'T',
                       '7', 'A', 'E', 'u', 'c', 'L', 'e', 'd', 'M'});
